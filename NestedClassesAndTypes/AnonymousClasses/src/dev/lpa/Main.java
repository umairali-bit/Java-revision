package dev.lpa;//package src.dev.lpa;
//
//
//
//import src.dev.lpa.domain.Employee;
//import src.dev.lpa.domain.StoreEmployee;
//
...
//
//        List <StoreEmployee> storeEmployee = new ArrayList<>(List.of(
...
//        storeEmployee.sort(comparator);
//
//        for (StoreEmployee e : storeEmployee) {
//            System.out.println(e);
//        }
//
//
//        System.out.println("With Pig Latin Name");
//        addPigLatinName(storeEmployee);
//
//
//
//
